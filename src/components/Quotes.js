...
const Quotes = () => {
  ...
  <span><b>R</b></span>
      ...
      <center><button  class="btn btn-dark"   onClick={copyQuote} id="copy-quote" style={{borderRadius:'6px'}}>
          <h3>  {isCopied ? 'Copied!' : 'Copy'}</h3>
            </button></center>
           <center><button class="btn btn-dark"  onClick={toggleTheme} style={{borderRadius:'7px'}}><h3>Toggle Theme</h3></button></center>
      <Footer/>
    </div>
  )
}
